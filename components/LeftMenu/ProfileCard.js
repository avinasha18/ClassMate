...
const ProfileCard = async ({id , userData}) => {
    ...
    <div className="p-3 bg-white rounded-lg shadow-md text-sm flex flex-col gap-6">
      <div className="h-20 relative">
        ...
        <Image
          ...
          width={48}
          height={48}
          className="rounded-full object-cover w-12 h-12 absolute left-0 right-0 m-auto -bottom-2 ring-1 ring-white z-10"
        />
      </div>
      <div className="h-20 flex flex-col gap-2 items-center">
        ...
        <Link href={`/dashboard/${userData.id}/profile`}>
